...
void main() {
	...
	`}function NT(s){let t=new WeakMap,i=null;function r(d){if(d&&d.isTexture){const m=d.mapping,p=m===bp||m===Ep,g=m===Is||m===ko;if(p||g){let _=t.get(d);const x=_!==void 0?_.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==x)return i===null&&(i=new Rv(s)),_=p?i.fromEquirectangular(d,_):i.fromCubemap(d,_),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),_.texture;if(_!==void 0)return _.texture;{const M=d.image;return p&&M&&M.height>0||g&&M&&l(M)?(i===null&&(i=new Rv(s)),_=p?i.fromEquirectangular(d):i.fromCubemap(d),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),d.addEventListener("dispose",c),_.texture):null}}}return d}function l(d){let m=0;const p=6;for(let g=0;g<p;g++)d[g]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function h(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function OT(s){const t={};function i(r){if(t[r]!==void 0)return t[r];const l=s.getExtension(r);return t[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&ec("WebGLRenderer: "+r+" extension not supported."),l}}}function PT(s,t,i,r){const l={},c=new WeakMap;function h(_){const x=_.target;x.index!==null&&t.remove(x.index);for(const A in x.attributes)t.remove(x.attributes[A]);x.removeEventListener("dispose",h),delete l[x.id];const M=c.get(x);M&&(t.remove(M),c.delete(x)),r.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,i.memory.geometries--}function d(_,x){return l[x.id]===!0||(x.addEventListener("dispose",h),l[x.id]=!0,i.memory.geometries++),x}function m(_){const x=_.attributes;for(const M in x)t.update(x[M],s.ARRAY_BUFFER)}function p(_){const x=[],M=_.index,A=_.attributes.position;let R=0;if(M!==null){const z=M.array;R=M.version;for(let N=0,O=z.length;N<O;N+=3){const B=z[N+0],P=z[N+1],F=z[N+2];x.push(B,P,P,F,F,B)}}else if(A!==void 0){const z=A.array;R=A.version;for(let N=0,O=z.length/3-1;N<O;N+=3){const B=N+0,P=N+1,F=N+2;x.push(B,P,P,F,F,B)}}else return;const E=new(vx(x)?bx:Mx)(x,1);E.version=R;const y=c.get(_);y&&t.remove(y),c.set(_,E)}function g(_){const x=c.get(_);if(x){const M=_.index;M!==null&&x.version<M.version&&p(_)}else p(_);return c.get(_)}return{get:d,update:m,getWireframeAttribute:g}}function FT(s,t,i){let r;function l(x){r=x}let c,h;function d(x){c=x.type,h=x.bytesPerElement}function m(x,M){s.drawElements(r,M,c,x*h),i.update(M,r,1)}function p(x,M,A){A!==0&&(s.drawElementsInstanced(r,M,c,x*h,A),i.update(M,r,A))}function g(x,M,A){if(A===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,M,0,c,x,0,A);let E=0;for(let y=0;y<A;y++)E+=M[y];i.update(E,r,1)}function _(x,M,A,R){if(A===0)return;const E=t.get("WEBGL_multi_draw");if(E===null)for(let y=0;y<x.length;y++)p(x[y]/h,M[y],R[y]);else{E.multiDrawElementsInstancedWEBGL(r,M,0,c,x,0,R,0,A);let y=0;for(let z=0;z<A;z++)y+=M[z]*R[z];i.update(y,r,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function IT(s){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(c,h,d){switch(i.calls++,h){case s.TRIANGLES:i.triangles+=d*(c/3);break;case s.LINES:i.lines+=d*(c/2);break;case s.LINE_STRIP:i.lines+=d*(c-1);break;case s.LINE_LOOP:i.lines+=d*c;break;case s.POINTS:i.points+=d*c;break;default:an("WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:r}}function BT(s,t,i){const r=new WeakMap,l=new Nn;function c(h,d,m){const p=h.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,_=g!==void 0?g.length:0;let x=r.get(d);if(x===void 0||x.count!==_){let C=function(){F.dispose(),r.delete(d),d.removeEventListener("dispose",C)};x!==void 0&&x.texture.dispose();const M=d.morphAttributes.position!==void 0,A=d.morphAttributes.normal!==void 0,R=d.morphAttributes.color!==void 0,E=d.morphAttributes.position||[],y=d.morphAttributes.normal||[],z=d.morphAttributes.color||[];let N=0;M===!0&&(N=1),A===!0&&(N=2),R===!0&&(N=3);let O=d.attributes.position.count*N,B=1;O>t.maxTextureSize&&(B=Math.ceil(O/t.maxTextureSize),O=t.maxTextureSize);const P=new Float32Array(O*B*4*_),F=new xx(P,O,B,_);F.type=Ua,F.needsUpdate=!0;const Z=N*4;for(let U=0;U<_;U++){const k=E[U],j=y[U],nt=z[U],pt=O*B*4*U;for(let xt=0;xt<k.count;xt++){const H=xt*Z;M===!0&&(l.fromBufferAttribute(k,xt),P[pt+H+0]=l.x,P[pt+H+1]=l.y,P[pt+H+2]=l.z,P[pt+H+3]=0),A===!0&&(l.fromBufferAttribute(j,xt),P[pt+H+4]=l.x,P[pt+H+5]=l.y,P[pt+H+6]=l.z,P[pt+H+7]=0),R===!0&&(l.fromBufferAttribute(nt,xt),P[pt+H+8]=l.x,P[pt+H+9]=l.y,P[pt+H+10]=l.z,P[pt+H+11]=nt.itemSize===4?l.w:1)}}x={count:_,texture:F,size:new Le(O,B)},r.set(d,x),d.addEventListener("dispose",C)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)m.getUniforms().setValue(s,"morphTexture",h.morphTexture,i);else{let M=0;for(let R=0;R<p.length;R++)M+=p[R];const A=d.morphTargetsRelative?1:1-M;m.getUniforms().setValue(s,"morphTargetBaseInfluence",A),m.getUniforms().setValue(s,"morphTargetInfluences",p)}m.getUniforms().setValue(s,"morphTargetsTexture",x.texture,i),m.getUniforms().setValue(s,"morphTargetsTextureSize",x.size)}return{update:c}}function zT(s,t,i,r){let l=new WeakMap;function c(m){const p=r.render.frame,g=m.geometry,_=t.get(m,g);if(l.get(_)!==p&&(t.update(_),l.set(_,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,s.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,s.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const x=m.skeleton;l.get(x)!==p&&(x.update(),l.set(x,p))}return _}function h(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:h}}const HT={[ix]:"LINEAR_TONE_MAPPING",[ax]:"REINHARD_TONE_MAPPING",[rx]:"CINEON_TONE_MAPPING",[hm]:"ACES_FILMIC_TONE_MAPPING",[ox]:"AGX_TONE_MAPPING",[lx]:"NEUTRAL_TONE_MAPPING",[sx]:"CUSTOM_TONE_MAPPING"};function VT(s,t,i,r,l){const c=new Oa(t,i,{type:s,depthBuffer:r,stencilBuffer:l}),h=new Oa(t,i,{type:dr,depthBuffer:!1,stencilBuffer:!1}),d=new ei;d.setAttribute("position",new yi([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new yi([0,2,0,0,2,0],2));const m=new AM({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+y);const N=z+E+h,O=z+y+d,B=Iv(l,l.VERTEX_SHADER,N),P=Iv(l,l.FRAGMENT_SHADER,O);l.attachShader(R,B),l.attachShader(R,P),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function F(k){if(s.debug.checkShaderErrors){const j=l.getProgramInfoLog(R)||"",nt=l.getShaderInfoLog(B)||"",pt=l.getShaderInfoLog(P)||"",xt=j.trim(),H=nt.trim(),Y=pt.trim();let st=!0,Pt=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(st=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,R,B,P);else{const Ut=zv(l,B,"vertex"),V=zv(l,P,"fragment");an("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
...
`);navigator.clipboard.writeText(j).then(()=>{U(!0),setTimeout(()=>U(!1),2e3)})};return at.jsxs("div",{className:"flex flex-col gap-3",children:[at.jsx("button",{onClick:F,disabled:!g||x,className:`w-full py-3.5 px-4 rounded-xl font-semibold text-sm transition-all
          ...
          flex items-center justify-center gap-2`,children:x?at.jsxs(at.Fragment,{children:[at.jsxs("svg",{className:"animate-spin w-4 h-4",fill:"none",viewBox:"0 0 24 24",children:[at.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),at.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),"Generating…"]}):at.jsxs(at.Fragment,{children:[at.jsx("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3l-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3l-3 3"})}),"Generate Base"]})}),!_&&g&&!x&&at.jsx("p",{className:"text-xs text-yellow-400/70 text-center",children:"Adjust settings below, then generate."}),g&&at.jsxs("div",{className:"bg-gray-900/50 border border-gray-800 rounded-xl p-3",children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-2",children:"Workflow"}),at.jsx("div",{className:"grid grid-cols-2 gap-1.5",children:Object.keys(Xu).map(j=>at.jsx("button",{onClick:()=>P(j),disabled:x,className:`
              ...
              flex items-center justify-center gap-2`,children:[at.jsx("svg",{className:"w-5 h-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3"})}),"Download STL"]}),at.jsxs("div",{className:"flex items-center justify-between text-xs text-emerald-400/70",children:[at.jsxs("span",{children:[s,"×",t," grid · ",l?"magnets":"",l&&c?" + ":"",c?"screws":"",!l&&!c?"no features":""]}),at.jsx("button",{onClick:k,className:"flex items-center gap-1 px-2 py-1 rounded-md hover:bg-emerald-800/30 transition-colors",children:C?at.jsxs(at.Fragment,{children:[at.jsx("svg",{className:"w-3 h-3",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M4.5 12.75l6 6 9-13.5"})}),"Copied!"]}):at.jsxs(at.Fragment,{children:[at.jsx("svg",{className:"w-3 h-3",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 01-.75.75H9.75a.75.75 0 01-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184"})}),"Copy settings"]})})]})]}),at.jsx(fp,{title:"Grid Size",defaultOpen:!0,badge:g?`${s}×${t}`:void 0,children:at.jsxs("div",{className:"space-y-3",children:[g&&at.jsxs("div",{children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-2",children:"Fitting Mode"}),at.jsx("div",{className:"flex gap-1",children:Object.keys(hp).map(j=>at.jsx("button",{onClick:()=>O(j),disabled:x,className:`
                      ...
                      disabled:opacity-50 disabled:cursor-not-allowed
                    `,children:at.jsx("div",{className:"font-medium",children:hp[j].label})},j))})]}),at.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[at.jsxs("div",{children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-1",children:"Grid X"}),at.jsx("input",{type:"number",min:1,max:20,value:s,onChange:j=>A(Math.max(1,parseInt(j.target.value)||1)),disabled:!g||x||h!=="custom",className:`w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm
                  text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
                  disabled:opacity-50 disabled:cursor-not-allowed`})]}),at.jsxs("div",{children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-1",children:"Grid Y"}),at.jsx("input",{type:"number",min:1,max:20,value:t,onChange:j=>R(Math.max(1,parseInt(j.target.value)||1)),disabled:!g||x||h!=="custom",className:`w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm
                  text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
                  disabled:opacity-50 disabled:cursor-not-allowed`})]})]}),at.jsxs("div",{className:"text-xs text-gray-500",children:["Base: ",(s*42).toFixed(0)," × ",(t*42).toFixed(0)," mm · Height: ",cm.toFixed(1)," mm"]})]})}),g&&at.jsx(fp,{title:"Orientation",badge:d,children:at.jsxs("div",{children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-2",children:"Bottom Face"}),at.jsx("div",{className:"grid grid-cols-3 gap-1.5",children:c2.map(j=>at.jsx("button",{title:j.title,onClick:()=>B(j.axis),disabled:x,className:`
                    ...
                    disabled:opacity-50 disabled:cursor-not-allowed
                  `,children:j.label},j.axis))}),at.jsx("p",{className:"text-[10px] text-gray-600 mt-1.5",children:"Rotate model so a different face becomes the bottom"})]})}),at.jsx(fp,{title:"Offset & Features",children:at.jsxs("div",{className:"space-y-3",children:[at.jsxs("div",{children:[at.jsxs("label",{className:"block text-xs font-medium text-gray-400 mb-1",children:["Offset X: ",i.toFixed(1)," mm"]}),at.jsx("input",{type:"range",min:-21,max:21,step:.5,value:i,onChange:j=>E(parseFloat(j.target.value)),disabled:!g||x,className:`w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer
                accent-blue-500 disabled:opacity-50 disabled:cursor-not-allowed`})]}),at.jsxs("div",{children:[at.jsxs("label",{className:"block text-xs font-medium text-gray-400 mb-1",children:["Offset Y: ",r.toFixed(1)," mm"]}),at.jsx("input",{type:"range",min:-21,max:21,step:.5,value:r,onChange:j=>y(parseFloat(j.target.value)),disabled:!g||x,className:`w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer
                accent-blue-500 disabled:opacity-50 disabled:cursor-not-allowed`})]}),at.jsxs("div",{className:"space-y-2 pt-1",children:[at.jsxs("label",{className:"flex items-center gap-3 p-2.5 rounded-lg hover:bg-gray-800/50 transition-colors cursor-pointer",children:[at.jsx("input",{type:"checkbox",checked:l,onChange:j=>z(j.target.checked),disabled:!g||x,className:`w-5 h-5 rounded bg-gray-800 border-gray-600 text-blue-500
                  focus:ring-blue-500 focus:ring-offset-gray-900
                  disabled:opacity-50 disabled:cursor-not-allowed`}),at.jsxs("div",{children:[at.jsx("div",{className:"text-sm text-gray-300",children:"Magnet holes"}),at.jsx("div",{className:"text-[10px] text-gray-600",children:"6×3mm round magnets"})]})]}),at.jsxs("label",{className:"flex items-center gap-3 p-2.5 rounded-lg hover:bg-gray-800/50 transition-colors cursor-pointer",children:[at.jsx("input",{type:"checkbox",checked:c,onChange:j=>N(j.target.checked),disabled:!g||x,className:`w-5 h-5 rounded bg-gray-800 border-gray-600 text-blue-500
                  focus:ring-blue-500 focus:ring-offset-gray-900
                  disabled:opacity-50 disabled:cursor-not-allowed`}),at.jsxs("div",{children:[at.jsx("div",{className:"text-sm text-gray-300",children:"Screw holes"}),at.jsx("div",{className:"text-[10px] text-gray-600",children:"M3 countersunk"})]})]})]})]})}),p&&at.jsxs("div",{className:"bg-gray-900/50 rounded-xl p-3 text-xs text-gray-400 space-y-1",children:[at.jsx("div",{className:"font-medium text-gray-300",children:"Model Dimensions"}),at.jsxs("div",{className:"grid grid-cols-3 gap-2 text-center",children:[at.jsxs("div",{children:[at.jsx("div",{className:"text-gray-500 text-[10px]",children:"Width"}),at.jsx("div",{children:p.width.toFixed(1)})]}),at.jsxs("div",{children:[at.jsx("div",{className:"text-gray-500 text-[10px]",children:"Depth"}),at.jsx("div",{children:p.depth.toFixed(1)})]}),at.jsxs("div",{children:[at.jsx("div",{className:"text-gray-500 text-[10px]",children:"Height"}),at.jsx("div",{children:p.height.toFixed(1)})]})]}),at.jsxs("div",{className:"text-center text-gray-600 text-[10px] pt-1",children:["Grid unit: ",Te,"mm · All processing runs in your browser"]})]})]})}function f2({message:s,type:t="success",duration:i=4e3,onDismiss:r}){const[l,c]=Me.useState(!1);Me.useEffect(()=>{requestAnimationFrame(()=>c(!0));const d=setTimeout(()=>{c(!1),setTimeout(r,300)},i);return()=>clearTimeout(d)},[i,r]);const h=t==="success"?"bg-emerald-900/90 border-emerald-600/50 text-emerald-200":t==="error"?"bg-red-900/90 border-red-600/50 text-red-200":"bg-blue-900/90 border-blue-600/50 text-blue-200";return at.jsx("div",{className:`
