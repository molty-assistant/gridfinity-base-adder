...
`);navigator.clipboard.writeText(j).then(()=>{U(!0),setTimeout(()=>U(!1),2e3)})};return at.jsxs("div",{className:"flex flex-col gap-3",children:[at.jsx("button",{onClick:F,disabled:!g||x,className:`w-full py-3.5 px-4 rounded-xl font-semibold text-sm transition-all
          ...
          flex items-center justify-center gap-2`,children:x?at.jsxs(at.Fragment,{children:[at.jsxs("svg",{className:"animate-spin w-4 h-4",fill:"none",viewBox:"0 0 24 24",children:[at.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),at.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),"Generating…"]}):at.jsxs(at.Fragment,{children:[at.jsx("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3l-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3l-3 3"})}),"Generate Base"]})}),!_&&g&&!x&&at.jsx("p",{className:"text-xs text-yellow-400/70 text-center",children:"Adjust settings below, then generate."}),g&&at.jsxs("div",{className:"bg-gray-900/50 border border-gray-800 rounded-xl p-3",children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-2",children:"Workflow"}),at.jsx("div",{className:"grid grid-cols-2 gap-1.5",children:Object.keys(Xu).map(j=>at.jsx("button",{onClick:()=>P(j),disabled:x,className:`
              ...
              flex items-center justify-center gap-2`,children:[at.jsx("svg",{className:"w-5 h-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3"})}),"Download STL"]}),at.jsxs("div",{className:"flex items-center justify-between text-xs text-emerald-400/70",children:[at.jsxs("span",{children:[s,"×",t," grid · ",l?"magnets":"",l&&c?" + ":"",c?"screws":"",!l&&!c?"no features":""]}),at.jsx("button",{onClick:k,className:"flex items-center gap-1 px-2 py-1 rounded-md hover:bg-emerald-800/30 transition-colors",children:C?at.jsxs(at.Fragment,{children:[at.jsx("svg",{className:"w-3 h-3",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M4.5 12.75l6 6 9-13.5"})}),"Copied!"]}):at.jsxs(at.Fragment,{children:[at.jsx("svg",{className:"w-3 h-3",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:at.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 01-.75.75H9.75a.75.75 0 01-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184"})}),"Copy settings"]})})]})]}),at.jsx(fp,{title:"Grid Size",defaultOpen:!0,badge:g?`${s}×${t}`:void 0,children:at.jsxs("div",{className:"space-y-3",children:[g&&at.jsxs("div",{children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-2",children:"Fitting Mode"}),at.jsx("div",{className:"flex gap-1",children:Object.keys(hp).map(j=>at.jsx("button",{onClick:()=>O(j),disabled:x,className:`
                  ...
                  text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
                  disabled:opacity-50 disabled:cursor-not-allowed`})]})]}),at.jsxs("div",{className:"text-xs text-gray-500",children:["Base: ",(s*42).toFixed(0)," × ",(t*42).toFixed(0)," mm · Height: ",cm.toFixed(1)," mm"]})]})}),g&&at.jsx(fp,{title:"Orientation",badge:d,children:at.jsxs("div",{children:[at.jsx("label",{className:"block text-xs font-medium text-gray-400 mb-2",children:"Bottom Face"}),at.jsx("div",{className:"grid grid-cols-3 gap-1.5",children:d2.map(j=>at.jsx("button",{title:j.title,onClick:()=>B(j.axis),disabled:x,className:`
...
`),vt+=`};
`,It.push(vt);var Ye=Dn(Function,It)(...Ot),Cn=`methodCaller<(${G.map(yn=>yn.name).join(", ")}) => ${rt.name}>`;return bf(mi(Cn,Ye))}function dc(v,S){return v>>>=0,S>>>=0,v=xn.toValue(v),S=xn.toValue(S),xn.toHandle(v[S])}function Af(v){v>>>=0,v>9&&(Ei[v+1]+=1)}function Rf(v){return v>>>=0,xn.toHandle(hc(v))}function Cf(){return xn.toHandle({})}function wf(v){v>>>=0;var S=xn.toValue(v);ue(S),Ii(v)}function Df(v,S,L){v>>>=0,S>>>=0,L>>>=0,v=xn.toValue(v),S=xn.toValue(S),L=xn.toValue(L),v[S]=L}function Uf(v,S){v>>>=0,S>>>=0,v=Ma(v,"_emval_take_value");var L=v.readValueFromPointer(S);return xn.toHandle(L)}var Lf=()=>4294901760,Nf=v=>{var S=B.buffer,L=(v-S.byteLength+65535)/65536;try{return B.grow(L),xt(),1}catch{}};function Of(v){v>>>=0;var S=Z.length,L=Lf();if(v>L)return!1;for(var G=(It,Ot)=>It+(Ot-It%Ot)%Ot,rt=1;rt<=4;rt*=2){var vt=S*(1+.2/rt);vt=Math.min(vt,v+100663296);var Lt=Math.min(L,G(Math.max(v,vt),65536)),Mt=Nf(Lt);if(Mt)return!0}return!1}var Ys=(v,S)=>{v<128?S.push(v):S.push(v%128|128,v>>7)},cs=v=>{for(var S={i:"i32",j:"i64",f:"f32",d:"f64",e:"externref",p:"i32"},L={parameters:[],results:v[0]=="v"?[]:[S[v[0]]]},G=1;G<v.length;++G)L.parameters.push(S[v[G]]);return L},Pf=(v,S)=>{var L=v.slice(0,1),G=v.slice(1),rt={i:127,p:127,j:126,f:125,d:124,e:111};S.push(96),Ys(G.length,S);for(var vt=0;vt<G.length;++vt)S.push(rt[G[vt]]);L=="v"?S.push(0):S.push(1,rt[L])},pc=(v,S)=>{if(typeof WebAssembly.Function=="function")return new WebAssembly.Function(cs(S),v);var L=[1];Pf(S,L);var G=[0,97,115,109,1,0,0,0,1];Ys(L.length,G),G.push(...L),G.push(2,7,1,1,101,1,102,0,0,7,5,1,1,102,0,0);var rt=new WebAssembly.Module(new Uint8Array(G)),vt=new WebAssembly.Instance(rt,{e:{f:v}}),Lt=vt.exports.f;return Lt},mc=(v,S)=>{if(Ea)for(var L=v;L<v+S;L++){var G=on(L);G&&Ea.set(G,L)}},Ea,gc=v=>(Ea||(Ea=new WeakMap,mc(0,sn.length)),Ea.get(v)||0),qs=[],xr=()=>{if(qs.length)return qs.pop();try{sn.grow(1)}catch(v){throw v instanceof RangeError?"Unable to grow wasm table. Set ALLOW_TABLE_GROWTH.":v}return sn.length-1},rl=(v,S)=>sn.set(v,S),us=(v,S)=>{var L=gc(v);if(L)return L;var G=xr();try{rl(G,v)}catch(vt){if(!(vt instanceof TypeError))throw vt;var rt=pc(v,S);rl(G,rt)}return Ea.set(v,G),G},fs=v=>{Ea.delete(on(v)),rl(v,null),qs.push(v)};Ht=r.InternalError=class extends Error{constructor(S){super(S),this.name="InternalError"}},Q(),Kt=r.BindingError=class extends Error{constructor(S){super(S),this.name="BindingError"}},Sa(),gr(),ve(),zn=r.UnboundTypeError=Re(Error,"UnboundTypeError"),Qo();var _c={i:bt,D:Ct,n:Wt,C:De,H:rn,h:Mi,g:_r,a:hf,G:$o,t:sc,e:fa,x:ba,c:tl,j:oc,f:ks,k:Xs,w:el,s:nl,o:_f,l:vf,I:xf,F:yf,v:fc,z:Mf,b:Ii,m:al,y:Tf,B:dc,u:Af,q:Rf,A:Cf,p:wf,r:Df,d:Uf,E:Of},Ti=Ce(),yr=v=>(yr=Ti.L)(v),Va=v=>(Va=Ti.N)(v),ha=v=>(ha=Ti.O)(v),hs=v=>(hs=Ti.P)(v);function vc(v){v=Object.assign({},v);var S=G=>rt=>G(rt)>>>0,L=G=>()=>G()>>>0;return v.L=S(v.L),v.N=S(v.N),v._emscripten_stack_alloc=S(v._emscripten_stack_alloc),v.emscripten_stack_get_current=L(v.emscripten_stack_get_current),v}r.addFunction=us,r.removeFunction=fs;var ds;lt=function v(){ds||Zs(),ds||(lt=v)};function Zs(){if(jt>0||(Pt(),jt>0))return;function v(){ds||(ds=!0,r.calledRun=!0,!P&&(Ut(),l(r),r.onRuntimeInitialized?.(),V()))}r.setStatus?(r.setStatus("Running..."),setTimeout(function(){setTimeout(function(){r.setStatus("")},1),v()},1)):v()}if(r.preInit)for(typeof r.preInit=="function"&&(r.preInit=[r.preInit]);r.preInit.length>0;)r.preInit.pop()();return Zs(),i=h,i})})();let Io=null;async function ex(){return Io||(Io=await b2(),typeof Io.setup=="function"&&Io.setup(),Io)}function dp(s){return s instanceof Error?s.message:String(s)}function E2(s){const t=s.getAttribute("position");if(!t)throw new Error("Geometry has no position attribute");const i=new Float32Array(t.array.length);i.set(t.array);const r=s.getIndex();if(r)return{positions:i,indices:new Uint32Array(r.array)};const l=new Uint32Array(t.count);for(let c=0;c<t.count;c++)l[c]=c;return{positions:i,indices:l}}function T2(s){const t=s.reduce((m,p)=>m+p.positions.length,0),i=s.reduce((m,p)=>m+p.indices.length,0),r=new Float32Array(t),l=new Uint32Array(i);let c=0,h=0,d=0;for(const m of s){r.set(m.positions,c);for(let p=0;p<m.indices.length;p++)l[h+p]=m.indices[p]+d;c+=m.positions.length,h+=m.indices.length,d+=m.positions.length/3}return{positions:r,indices:l}}function A2(s){const t=new An;switch(s){case"-z":return t;case"+z":return t.makeRotationX(Math.PI);case"+x":return t.makeRotationY(-Math.PI/2);case"-x":return t.makeRotationY(Math.PI/2);case"+y":return t.makeRotationX(Math.PI/2);case"-y":return t.makeRotationX(-Math.PI/2);default:return t}}function R2(){const s=Se.useRef(null),[t,i]=Se.useState(null),[r,l]=Se.useState(null),[c,h]=Se.useState(null),[d,m]=Se.useState(null),[p,g]=Se.useState(""),[_,x]=Se.useState(0),[M,A]=Se.useState(1),[R,E]=Se.useState(1),[y,z]=Se.useState(0),[N,O]=Se.useState(0),[B,P]=Se.useState(!0),[F,Z]=Se.useState(!1),[C,U]=Se.useState("inside"),[k,j]=Se.useState("-z"),[nt,pt]=Se.useState("outside"),[xt,H]=Se.useState(!1),[Y,st]=Se.useState(!1),[Pt,Ut]=Se.useState(null),[V,ut]=Se.useState(null),Et=Se.useRef(null);Se.useEffect(()=>{ex().then(()=>st(!0)).catch(fe=>{console.error("Failed to init Manifold:",fe),Ut("Failed to initialize 3D engine. Please refresh the page.")})},[]),Se.useEffect(()=>{const fe="kofi-overlay-widget-script",se=()=>{if(window.__kofiOverlayInit)return;const Ve=window.kofiWidgetOverlay;!Ve||typeof Ve.draw!="function"||(Ve.draw("lightscout",{type:"floating-chat","floating-chat.donateButton.text":"Support me","floating-chat.donateButton.background-color":"#00b9fe","floating-chat.donateButton.text-color":"#fff"}),window.__kofiOverlayInit=!0)},ce=document.getElementById(fe);if(ce){window.kofiWidgetOverlay?se():ce.addEventListener("load",se,{once:!0});return}const te=document.createElement("script");return te.id=fe,te.src="https://storage.ko-fi.com/cdn/scripts/overlay-widget.js",te.async=!0,te.onload=se,document.body.appendChild(te),()=>{te.onload=null}},[]);const Vt=Se.useCallback((fe,se)=>{const ce=fe.clone(),te=A2(se);ce.applyMatrix4(te),ce.computeBoundingBox();const Ve=Jv(ce);ce.translate(-Ve.centerX,-Ve.centerY,-Ve.minZ),ce.computeBoundingBox();const W=Jv(ce);return{geometry:ce,dims:{width:W.width,depth:W.depth,height:W.height,minX:W.minX,maxX:W.maxX,minY:W.minY,maxY:W.maxY,minZ:W.minZ,maxZ:W.maxZ,centerX:W.centerX,centerY:W.centerY}}},[]),jt=Se.useCallback((fe,se)=>{if(se==="custom")return;const ce=Qv(fe.width,fe.depth,se);A(ce.gridX),E(ce.gridY)},[]),lt=Se.useCallback((fe,se)=>{Ut(null);try{s.current&&s.current.dispose();const ce=_2(fe);s.current=ce;const te=ce.getAttribute("position"),Ve=ce.index,W=Ve?Ve.count/3:te.count/3;x(Math.round(W));const{geometry:Je,dims:Ce}=Vt(ce,k);i(Yt=>(Yt?.dispose(),Je)),m(Ce),g(se);const Oe=Qv(Ce.width,Ce.depth,C);A(Oe.gridX),E(Oe.gridY),pt("outside"),l(Yt=>(Yt?.dispose(),null)),h(Yt=>(Yt?.dispose(),null)),Et.current=null,z(0),O(0)}catch(ce){console.error("Failed to parse STL:",ce),Ut(`Failed to parse STL file: ${dp(ce)}`)}},[Vt,k,C]),St=Se.useCallback(()=>{s.current&&(s.current.dispose(),s.current=null),t?.dispose(),r?.dispose(),c?.dispose(),i(null),l(null),h(null),m(null),g(""),x(0),Et.current=null,z(0),O(0),j("-z"),pt("outside"),Ut(null)},[t,r,c]),kt=Se.useCallback(fe=>{if(!s.current)return;j(fe);const{geometry:se,dims:ce}=Vt(s.current,fe);i(te=>(te?.dispose(),se)),m(ce),jt(ce,C),l(te=>(te?.dispose(),null)),h(te=>(te?.dispose(),null)),Et.current=null,z(0),O(0)},[Vt,C,jt]),ae=Se.useCallback(fe=>{U(fe),d&&jt(d,fe),l(se=>(se?.dispose(),null)),h(se=>(se?.dispose(),null)),Et.current=null},[d,jt]),re=Se.useCallback(fe=>{pt(fe),l(se=>(se?.dispose(),null)),h(se=>(se?.dispose(),null)),Et.current=null},[]),Ne=Se.useCallback(async()=>{if(!t||!Y)return;H(!0),Ut(null),h(te=>(te?.dispose(),null)),l(te=>(te?.dispose(),null)),Et.current=null;let fe=null,se=null,ce=null;try{const te=await ex();fe=await c2(te,{gridX:M,gridY:R,offsetX:y,offsetY:N,magnets:B,screws:F});const W=fe.getMesh(),Je=$v(W),Ce=new ei;Ce.setAttribute("position",new Zn(Je.positions,3)),Ce.setIndex(new Zn(Je.indices,1)),Ce.computeVertexNormals(),nt==="outside"&&Ce.translate(0,0,-cm),l(Ce);const Oe=t.clone();nt==="outside"&&Oe.translate(0,0,cm);const Yt=u2(Oe,te);try{se=new te.Manifold(Yt)}catch(_t){console.warn("Model is not manifold, trying to fix...",dp(_t));const ue=E2(Oe),Gt=T2([ue,Je]),ne=new ei;ne.setAttribute("position",new Zn(Gt.positions,3)),ne.setIndex(new Zn(Gt.indices,1)),ne.computeVertexNormals(),h(ne),Et.current=Gt,Ut("Boolean union failed on this STL, so compatibility mode was used (model + base exported together as overlapping solids). Most slicers merge these automatically."),ut({message:"⚠️ Used compatibility mode for this STL",type:"info"});return}finally{Oe.dispose()}const I=se.volume();ce=se.add(fe);const T=ce.volume();nt==="inside"&&Math.abs(T-I)<1&&(Ut("Inside mode added almost no new volume. This model is likely mostly solid at that face. Try Turn Into Box, or rotate Bottom Face to an interior-facing side."),ut({message:"⚠️ Inside mode had minimal effect on this STL",type:"info"}));const $=ce.getMesh(),bt=$v($),Ct=new ei;Ct.setAttribute("position",new Zn(bt.positions,3)),Ct.setIndex(new Zn(bt.indices,1)),Ct.computeVertexNormals(),h(Ct),Et.current=bt,ut({message:"✅ Base generated! Preview below.",type:"success"})}catch(te){console.error("Generation failed:",te),Ut(`Generation failed: ${dp(te)}`),ut({message:"❌ Generation failed. Check error details.",type:"error"})}finally{ce?.delete(),se?.delete(),fe?.delete(),H(!1)}},[t,Y,M,R,y,N,B,F,nt]),cn=Se.useCallback(()=>{if(!Et.current)return;const{positions:fe,indices:se}=Et.current,ce=v2(fe,se),te=p.replace(/\.stl$/i,"");x2(ce,`${te}_gridfinity_${M}x${R}.stl`)},[p,M,R]);return at.jsxs("div",{className:"min-h-screen flex flex-col bg-gray-950",children:[V&&at.jsx(m2,{message:V.message,type:V.type,onDismiss:()=>ut(null)}),at.jsx("header",{className:"border-b border-gray-800 px-4 sm:px-6 py-3",children:at.jsxs("div",{className:"flex items-center gap-3",children:[at.jsx("div",{className:"text-xl",children:"🔲"}),at.jsxs("div",{children:[at.jsx("h1",{className:"text-lg font-bold text-gray-100",children:"Gridfinity Base Adder"}),at.jsx("p",{className:"text-xs text-gray-500 hidden sm:block",children:"Add Gridfinity-compatible bases to any STL model"})]}),at.jsxs("span",{className:"ml-auto text-[10px] font-mono text-gray-500 border border-gray-700 rounded px-2 py-0.5",children:["v","16"]}),!Y&&at.jsx("span",{className:"text-xs text-yellow-500 animate-pulse",children:"Loading engine…"})]})}),at.jsxs("div",{className:"flex-1 flex flex-col lg:flex-row overflow-hidden",children:[at.jsx("div",{className:"order-2 lg:order-1 flex-1 flex flex-col min-h-0",children:at.jsx("div",{className:"flex-1 p-3 min-h-0",children:at.jsx("div",{className:"h-full rounded-xl border border-gray-800 overflow-hidden",children:at.jsx(h2,{originalGeometry:t,baseGeometry:r,combinedGeometry:c,gridX:M,gridY:R,offsetX:y,offsetY:N,placement:nt})})})}),at.jsx("div",{className:"order-1 lg:order-2 w-full lg:w-80 xl:w-96 border-b lg:border-b-0 lg:border-l border-gray-800 overflow-y-auto",children:at.jsxs("div",{className:"p-3 lg:p-4 space-y-3",children:[at.jsx("div",{children:p?at.jsx(VA,{filename:p,triangleCount:_,dimensions:d,onRemove:St}):at.jsx(HA,{onFileLoaded:lt,disabled:!Y||xt})}),xt&&at.jsxs("div",{className:"bg-blue-950/30 border border-blue-700/30 rounded-xl p-3 flex items-center gap-3",children:[at.jsx("div",{className:"relative w-8 h-8 shrink-0",children:at.jsxs("svg",{className:"animate-spin w-8 h-8 text-blue-500",fill:"none",viewBox:"0 0 24 24",children:[at.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"3"}),at.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]})}),at.jsxs("div",{children:[at.jsx("div",{className:"text-sm font-medium text-blue-300",children:"Generating base…"}),at.jsx("div",{className:"text-xs text-blue-400/60",children:"Boolean union in progress"})]})]}),Pt&&at.jsx("div",{className:"p-3 rounded-xl bg-red-950/50 border border-red-800 text-xs text-red-300",children:Pt}),at.jsx(p2,{gridX:M,gridY:R,offsetX:y,offsetY:N,magnets:B,screws:F,fitMode:C,orientation:k,placement:nt,modelDims:d,hasModel:!!t,hasBase:!!r,hasCombined:!!c,isProcessing:xt,filename:p,onGridXChange:A,onGridYChange:E,onOffsetXChange:z,onOffsetYChange:O,onMagnetsChange:P,onScrewsChange:Z,onFitModeChange:ae,onOrientationChange:kt,onPlacementChange:re,onGenerate:Ne,onDownload:cn})]})})]})]})}pS.createRoot(document.getElementById("root")).render(at.jsx(Se.StrictMode,{children:at.jsx(R2,{})}));
